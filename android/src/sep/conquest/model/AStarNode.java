 ...
 * class AStarPathFinder. Every instance has a reference to its predecessor as
 * well as an attribute for the navigation-costs.
 * 
...
public class AStarNode implements Comparable<AStarNode> {
	...
	/**
	 * The estimatedCosts for the node.
	 */
	private int estimatedCosts;

	/**
	 * The constructor expects a predecessor node, the MapNode instance and the
	 * corresponding navigation-costs.
	 * 
	 * @param predecessor
	 *            The predecessor entity.
	 * @param node
	 *            The MapNode instance.
	 * @param costs
	 *            The navigation costs.
	 */
	...
	/**
	 * Sets a new value for the estimated navigation-costs.
	 * 
	 * @param costs
	 *            The navigation-costs.
	 */
	public void setEstimatedCosts(int costs) {
		this.estimatedCosts = costs;
	}

	/**
	 * Returns the estimated navigation-costs.
	 * 
	 * @return The navigation-costs.
	 */
