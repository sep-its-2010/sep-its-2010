  ...
  public boolean handleRequest(IRequest request) {
    ...
    if (!(statusReq.getKind() == MessageType.RESPONSE_STATUS)) {
      ...
      synchronized (robot) {
        ...
        /*
         * In the PuckFactory the Orientation in the PuckStatus is set to the
         * default value DOWN. Don't know the position of the e-pucks
         */

        RobotStatus bufferStatus = robot.getRobotStatus().get(
            statusReq.getSender());
