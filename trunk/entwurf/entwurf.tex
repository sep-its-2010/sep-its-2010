...
\begin{document}
	...
	\section{e-Puck Roboter}
		...
		Die folgenden Abschnitte beschreiben die einzelnen Komponenten der Architektur näher.
			...
			Das Modul bildet die Grundlage für die Verwendung der IR-Abstandssensoren.
			...
			Hier findet eine Initialisierung der Datenrate und der Masterfunktionalität des I2C-Moduls statt.
			Außerdem werden die grundlegenden Übertragungsfunktionalitäten wie Adressierung, Lesen und Schreiben definiert. \\
			...
			Weiterhin stellt dieses Modul die Funktionen zum Auslesen der IR-Sensoren zur Verfügung, welche nach einer A/D Konvertierung zur 
