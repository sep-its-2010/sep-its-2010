...
typedef struct {
	...
	uint8_t aui8Data[30];
		...
		\vspace{0pt}
		{\includegraphics[height=14cm]{Surface.eps}}
		\end{minipage}
		 \hfill
		...
		\begin{figure}[H]
		\fbox{\includegraphics[height=1cm]{BottomLeftEdge.png}}\hfill
		\fbox{\includegraphics[height=1cm]{BottomRightEdge.png}}\hfill
		\fbox{\includegraphics[height=1cm]{BottomT.png}}\hfill
		\fbox{\includegraphics[height=1cm]{cross.png}}\hfill
		\fbox{\includegraphics[height=1cm]{LeftT.png}}\hfill
		\fbox{\includegraphics[height=1cm]{RightT.png}}\hfill
		\fbox{\includegraphics[height=1cm]{TopLeftEdge.png}}\hfill
		\fbox{\includegraphics[height=1cm]{TopRightEdge.png}}\hfill
		\fbox{\includegraphics[height=1cm]{TopT.png}}
		...
		\begin{figure}[H]
		\fbox{\includegraphics[height=1cm]{Visited1.png}}\hfill
		\fbox{\includegraphics[height=1cm]{Visited2.png}}\hfill
		\fbox{\includegraphics[height=1cm]{Visited3.png}}\hfill
		\fbox{\includegraphics[height=1cm]{Visited4.png}}
