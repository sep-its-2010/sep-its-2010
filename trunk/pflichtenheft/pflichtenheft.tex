	...
	\section{Produktfunktionen}
		...
		\subsection{Smartphone}
			...
			\subsubsection{Steuerungsfunktionen}		
				\begin{list}{\labelitemi}{\leftmargin=1cm}
					\item[\textbf{\textbackslash F290\textbackslash}] Steuerungsfunktion mit einem On-Screen-Joystick
					...
					\item[\textbf{\textbackslash F300\textbackslash}] Steuerungsfunktion mit dem eingebauten Beschleunigungssensoren
			...
			\subsubsection{Grafische Benutzeroberfläche}
				\begin{list}{\labelitemi}{\leftmargin=1cm}
					...
					\item[\textbf{\textbackslash F270W\textbackslash}] Zustandsvisualisierung (status + pfade)		
						\\ \textsl{Auf dem Smartphone wird für jeden e-puck Roboter der bisher abgefahrene Weg, die Anzahl der überfahreren, und ich will dass das etz funktioniert
					...
					\item[\textbf{\textbackslash F280W\textbackslash}] Internationalisierung	
						\\ \textsl{Es gibt die Möglichkeit zwischen deutscher und englischer Sprachausgabe zu wählen.}
				\end{list}
