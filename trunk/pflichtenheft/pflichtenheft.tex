...
\begin{document}
				...
				\begin{itemize}
					...
					\item Erkundung einer unbekannten rechtwinkligen Fläche ausgehend von fest definierten Startpositionen
						\\ \textsl{Das Spielfeld besteht aus einer Menge von vier quadratisch angeordneten Feldern. Diese sind rasterförmig und
						   zusammenhängend angeordnet. Vier Felder sind mindestens so groß, dass ein im Zentrum des Quadrats
	...
	\section{Benutzungsoberfläche}
			...
			Auf dem Frame `Karte' erfolgt die übersichtliche Darstellung des bereits erkundeten Gebiets. Außerdem werden
			...
			Wird kein verbindungsbereiter e-puck gefunden, so hat der Benutzer die Möglichkeit, erneut eine Suche zu starten.
