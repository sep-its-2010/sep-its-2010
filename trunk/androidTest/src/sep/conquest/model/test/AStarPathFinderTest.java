 ...
 *
 */
public class AStarPathFinderTest extends AndroidTestCase {
	...
	public void setUp() throws Exception {
		...
		assertEquals("Wrong number of nodes.",
						30, robot.getMap().getMapAsList().size());
	}
	...
	public void testFindPuckMapNodeMapNodeArray() {
		...
		MapNode dest1 = robot.getMap().getNode(5, 3);		
		assertNotNull("Destination-1 node wasn't found.", dest1);

		MapNode dest2 = robot.getMap().getNode(5, 4);		
		assertNotNull("Destination-2 node wasn't found.", dest2);
		
		MapNode dest3 = robot.getMap().getNode(2, 4);		
