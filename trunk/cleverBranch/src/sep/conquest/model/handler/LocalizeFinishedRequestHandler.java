...
/**
 * Handles LocalizeFinishedRequest messages.
 * 
 * @author Andreas Wilhelm
 *
 */
public class LocalizeFinishedRequestHandler extends Handler {
   ...
   */
  public LocalizeFinishedRequestHandler(Handler next, LogicThread exec) {
    super(next);
    lThread = exec;
  ...
  public boolean handleRequest(IRequest request) {
	  if(!(request.getKind() == MessageType.FINISHED_LOCALIZATION)){
