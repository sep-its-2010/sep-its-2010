...
\section{Leistungsmerkmale}
	Das System erf\"ullt einige Leistungsmerkmale, die das Projekt auszeichnen:
	\begin{itemize}
		\item{Effiziente Wegfindung} \\
			Die Wegfindung der e-puck Roboter wird durch Verwendung des A*-Algorithmus berechnet
		\item{Zwei verschiedene Steuerungsarten} \\
			Das System unterst\"utzt einerseits die Steuerung eines e-puck Roboters durch eine Touch-Steuerung sowie eine Kippsteuerung die durch das Auslesen
			von Beschleunigungssensoren realisiert wird
	\end{itemize}		
