...
\section{Systemanforderungen}
		\begin{itemize}
		\item{\bf  Smartphone mit Android Betriebssystem} \\
				...
				www.android.com .
		\item{\bf  e-puck Roboter ab Hardware Rev. 2} \\
				e-puck Roboter mit Erweiterungsmodul f\"ur Bodensensoren sind zur Erkundung und zum vollst\"andigen Betrieb notwendig.
		\item{\bf  Computer} \\
				Ein Computer mit Bluetoothadapter zum Flashen der e-puck Roboter.
		\item{\bf  MPLAB ICD 2 oder 3} \\
				Zum Ersetzen des Bootloaders auf dem e-puck Roboter braucht man MPLAB ICD 2 oder 3 inkl. eines Adapterkabels f\"ur den e-puck Roboter.
		\end{itemize}
\section{Betriebsbedingungen} 
		\begin{itemize}
		\item{\bf Ausreichende Stromversorgung} \\
				...
				aufgeladen sein. Ist dies nicht der Fall kann es zu unerwarteten Fehlern kommen und das System zum Abst\"urzen bringen!
		\item{\bf  Geeignete Bedingungen f\"ur Funknetzwerke} \\
		...
		\item{\bf  Gr\"o\ss e des zu erkundenen Terrains} \\
				...
				nicht aus die Erkundung vollst\"andig durchzuf\"uhren.
		\item{\bf  Spielfeldbedinungen} \\
				...
				Spielfeld darf w\"ahrend der Erkundung nicht ver\"andert werden und keine ung\"ultigen Passagen aufweisen. 
		\item{\bf  Umgebungsbedinungen} \\
		...
		\item{\bf  Weitere Betriebsbedinungen des Smartphones und der e-puck Roboter} \\
