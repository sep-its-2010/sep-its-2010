...
#define HAL_LED_PIN__0 _LATA6 ///< epuck LED 0 driver pin.
#define HAL_LED_PIN__1 _LATA7 ///< epuck LED 1 driver pin.
#define HAL_LED_PIN__2 _LATA9 ///< epuck LED 2 driver pin.
#define HAL_LED_PIN__3 _LATA12 ///< epuck LED 3 driver pin.
#define HAL_LED_PIN__4 _LATA10 ///< epuck LED 4 driver pin.
#define HAL_LED_PIN__5 _LATA13 ///< epuck LED 5 driver pin.
#define HAL_LED_PIN__6 _LATA14 ///< epuck LED 6 driver pin.
#define HAL_LED_PIN__7 _LATA15 ///< epuck LED 7 driver pin.
#define HAL_LED_PIN__F _LATC1 ///< epuck front LED driver pin.
#define HAL_LED_PIN__B _LATC2 ///< epuck body LED driver pin.

#define HAL_LED_PIN_DIR__0 _TRISA6 ///< epuck LED 0 pin direction.
#define HAL_LED_PIN_DIR__1 _TRISA7 ///< epuck LED 1 pin direction.
#define HAL_LED_PIN_DIR__2 _TRISA9 ///< epuck LED 2 pin direction.
#define HAL_LED_PIN_DIR__3 _TRISA12 ///< epuck LED 3 pin direction.
#define HAL_LED_PIN_DIR__4 _TRISA10 ///< epuck LED 4 pin direction.
#define HAL_LED_PIN_DIR__5 _TRISA13 ///< epuck LED 5 pin direction.
#define HAL_LED_PIN_DIR__6 _TRISA14 ///< epuck LED 6 pin direction.
#define HAL_LED_PIN_DIR__7 _TRISA15 ///< epuck LED 7 pin direction.
#define HAL_LED_PIN_DIR__F _TRISC1 ///< epuck front LED pin direction.
#define HAL_LED_PIN_DIR__B _TRISC2 ///< epuck body LED pin direction.

enum {
	HAL_LED_PIN_BV__0 = 1 << 0, ///< Bit value of the epuck LED 0.
	HAL_LED_PIN_BV__1 = 1 << 1, ///< Bit value of the epuck LED 1.
	HAL_LED_PIN_BV__2 = 1 << 2, ///< Bit value of the epuck LED 2.
	HAL_LED_PIN_BV__3 = 1 << 3, ///< Bit value of the epuck LED 3.
	HAL_LED_PIN_BV__4 = 1 << 4, ///< Bit value of the epuck LED 4.
	HAL_LED_PIN_BV__5 = 1 << 5, ///< Bit value of the epuck LED 5.
	HAL_LED_PIN_BV__6 = 1 << 6, ///< Bit value of the epuck LED 6.
	HAL_LED_PIN_BV__7 = 1 << 7, ///< Bit value of the epuck LED 7.
	HAL_LED_PIN_BV__F = 1 << 8, ///< Bit value of the epuck front LED.
	HAL_LED_PIN_BV__B = 1 << 9, ///< Bit value of the epuck body LED .

	HAL_LED_PIN_MASK__0 = 1 << 6, ///< Port bit mask of the epuck LED 0.
	HAL_LED_PIN_MASK__1 = 1 << 7, ///< Port bit mask of the epuck LED 1.
	HAL_LED_PIN_MASK__2 = 1 << 9, ///< Port bit mask of the epuck LED 2.
	HAL_LED_PIN_MASK__3 = 1 << 12, ///< Port bit mask of the epuck LED 3.
	HAL_LED_PIN_MASK__4 = 1 << 10, ///< Port bit mask of the epuck LED 4.
	HAL_LED_PIN_MASK__5 = 1 << 13, ///< Port bit mask of the epuck LED 5.
	HAL_LED_PIN_MASK__6 = 1 << 14, ///< Port bit mask of the epuck LED 6.
	HAL_LED_PIN_MASK__7 = 1 << 15, ///< Port bit mask of the epuck LED 7.
	HAL_LED_PIN_MASK__CIRCULAR = HAL_LED_PIN_MASK__0 | HAL_LED_PIN_MASK__1 | HAL_LED_PIN_MASK__2 | HAL_LED_PIN_MASK__3 |
								 HAL_LED_PIN_MASK__4 | HAL_LED_PIN_MASK__5 | HAL_LED_PIN_MASK__6 | HAL_LED_PIN_MASK__7, ///< Port bit mask of the circular epuck LEDs.

	HAL_LED_PIN_MASK__F = 1 << 1, ///< Port bit mask of the epuck front LED.
	HAL_LED_PIN_MASK__B = 1 << 2, ///< Port bit mask of the epuck body LED.
	HAL_LED_PIN_MASK__CHASSIS = HAL_LED_PIN_MASK__F | HAL_LED_PIN_MASK__B ///< Port bit mask of the epuck front and body LEDs.
};
