...
enum {
	SUBS_NODE__LINE_THRESHOLD = 200, ///< Specifies the threshold for line-detection.
	...
	SUBS_NODE__MOVE_ABOVE_CENTER = 252 ///< Specifies the number of steps which have to be performed by both motors to move the robot above the center of the node.
};
